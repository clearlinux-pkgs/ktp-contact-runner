...
Source0  : https://download.kde.org/stable/applications/18.12.2/src/ktp-contact-runner-18.12.2.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.2/src/ktp-contact-runner-18.12.2.tar.xz.sig
...
%prep
%setup -q -n ktp-contact-runner-18.12.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1557034873
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
