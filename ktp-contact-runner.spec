...
Source0  : https://download.kde.org/stable/applications/19.08.1/src/ktp-contact-runner-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/ktp-contact-runner-19.08.1.tar.xz.sig
...
%prep
%setup -q -n ktp-contact-runner-19.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567711893
mkdir -p clr-build
pushd clr-build
